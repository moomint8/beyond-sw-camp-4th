...
/* 설명. Gateway에서 RewritePath 필터 추가 후 segment만 넘어오게 한 이후 */
@RequestMapping("/")
public class FirstServiceController {

    /* 설명. @Value와 같이 application.yml 또는 환경설정 값 불러오기 위해 추가 */
    ...
    public String healthCheck() {
        ...
        /* 설명. first-service 어플리케이션 여러 개 실행 시(스케일 아웃) 실행되는 어플리케이션 확인(포트번호로) */
