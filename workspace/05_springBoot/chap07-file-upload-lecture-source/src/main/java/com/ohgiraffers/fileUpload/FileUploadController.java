...
public class FileUploadController {
    ...
    /* 설명. build된 파일 업로드할 경로를 가져오기 위해 ResourceLoader 의존성 주입 받기 */
    @Autowired
...
//        System.out.println("빌드된 single 디렉터리의 절대경로: " + resource.getFile().getAbsolutePath());
        String filePath = resource.getFile().getAbsolutePath();

        /* 설명. 사용자가 넘긴 파일을 확인하고, rename 해보기.(우리는 자바의 UUID 클래스를 활용, 날짜로도 가능) */
        ...
        try {
            ...
            /* 설명. DB를 다녀오는 BL(BusinessLogic) 구문 작성(DB에 저장) */
