...
public class ResponseEntityTestController {
    ...
    /* 설명. 2. 빌더를 활용한 메소드 체이닝 방식으로 ResponseEntity 객체 만들기(요즘 유형) */
    ...
    public ResponseEntity<ResponseMessage> findUserByNo(@PathVariable int userNo) {
        ...
        /* 설명. 요청 리소스(회원 번호와 일치하는 회원 한 명을 추출) */
     ...
     *  받아내야 한다. json 문자열의 각 프로퍼티 별로 받을 수도 있지만 한 번에 하나의 타입으로 다 받아낼 때는 커맨드 객체(UserDTO)를
