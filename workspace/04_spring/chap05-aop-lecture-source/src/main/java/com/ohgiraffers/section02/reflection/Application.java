...
public class Application {
    public static void main(String[] args) {
        ...
        /* 필기.
         *  리플렉션(Reflection)이란?
         *   컴파일된 자바코드에서 역으로 클래스를 불러 메소드 및 필드 정보를 구해오는 방법이다.
         ...
         *   1. 오버헤드 발생: 성능 저하를 발생시킬 수 있기 때문에 민감한 애플리케이션에서는 사용하지 않는다.
         *   2. 캡슐화 저해: private, protected로 설정한 member(또는 필드)에 접근 가능하기 때문에 코드 기능이 저하되며
         *                 여러가지 문제를 야기할 수 있다.
         */
