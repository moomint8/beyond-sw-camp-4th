...
public class LoggingAspect {
     ...
     *  포인트컷(point cut)은 여러 조인포인트들에 어드바이스(advice)를 적용할 곳을 지정한 것이다.
     ...
     *      접근 제어자가 public 이고, 반환형이 Integer인 경우
...
//        System.out.println("After Advice 동작");
    ...
    /* 설명. returning에 쓰인 이름이 반환 값이 넘어오는 매개변수명과 일치해야 한다.(result) */
     ...
     *  심지어 원본 조인 포인트를 언제 실행할지, 실행 자체를 안할지, 계속 실행할지 여부까지도 젷어한다.
     *  Around Advice의 조인포인트 매개변수는 ProceedingJoinPoint로 고정되어 있다.
