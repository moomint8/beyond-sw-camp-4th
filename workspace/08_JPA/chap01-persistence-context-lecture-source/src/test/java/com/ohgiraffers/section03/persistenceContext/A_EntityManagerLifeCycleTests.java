...
//        System.out.println("foundMenu = " + foundMenu);
    ...
    public void 준영속성_detach_테스트() {
         ...
         *  준영속상태를 만든 후 set을 해도 entityManager가 관리하는 객체가 아니므로
         *  assertEquals(5000, entityManager.find(Menu.class, 12).getMenuPrice()); 를 실행해도
         *  관리하는 12번이 없으므로 다시 select 해와 set 하기 전인 DB의 값을 불러와 에러가 난다.
         */
